...
def index():
    ...
    with tag('big'):
        with tag('a', ('href', '/pic.jpeg?w=640&h=400')): text('pic(VGA)'); text(' - ')
        with tag('a', ('href', '/pic.jpeg?w=1280&h=720')): text('pic(SD)'); text(' - ')
        with tag('a', ('href', '/pic.jpeg?w=1920&h=1080')): text('pic(HD)'); text(' - ')
        with tag('a', ('href', '/pic.jpeg?w=3440&h=1440')): text('pic(1440p)'); text(' - ')
        with tag('a', ('href', '/pic.jpeg?w=3840&h=2160')): text('pic(UHD)'); text(' - ')
